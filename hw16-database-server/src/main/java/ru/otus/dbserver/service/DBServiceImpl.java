...
import ru.otus.dbserver.cache.CacheElement;
...
import ru.otus.dbserver.dao.DataSetDAO;
...
public class DBServiceImpl implements DBService {
    ...
    private CacheEngine<String, ? extends DataSet> cacheEngine = DBHelper.getCacheEngine();
    ...
    public CacheInfo getCacheInfo() {
        return this.cacheEngine.getCacheInfo();
    }
