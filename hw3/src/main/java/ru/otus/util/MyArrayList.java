...
public class MyArrayList<T> implements List<T>{
    ...
    private void resize() {
        Object[] newElements = new Object[this.elements.length * 3];
    ...
    public T remove(int index) {
        ...
        Object elemToRemove = this.elements[index];
